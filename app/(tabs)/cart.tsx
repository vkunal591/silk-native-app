  ...
  const fetchCartData = useCallback(
    async (pageNum: number, reset = false) => {
      ...
      try {
        ...
        setCartItems(prev => (reset ? uniqueData : [...prev, ...uniqueData]));
  ...
  return (
    <View style={styles.container}>
          ...
          return (
            <View style={styles.cartItem}>
              ...
              <View style={styles.quantityContainer}>
                <TouchableOpacity onPress={() => handleQuantityChange(productId, 'decrement')}>
                  <Entypo name="minus" size={20} color="#000" />
                </TouchableOpacity>
                <Text style={styles.itemTitle}>{quantity}</Text>
                <TouchableOpacity onPress={() => handleQuantityChange(productId, 'increment')}>
      ...
      <View style={styles.footer}>
        ...
        >
          <Text style={styles.checkoutText}>Place Order ({selectedItems.length})</Text>
        </TouchableOpacity>
      </View>
